  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <div className="relative mb-8" style={{ overflow: "visible" }}>
        <div
          className="h-40 w-full rounded-2xl bg-gradient-to-r from-primary-600 to-blue-400 shadow-lg"
          style={{
            backgroundImage:
        ...
        <div
          className="absolute left-1/2 -bottom-20 transform -translate-x-1/2 z-20 flex flex-col items-center"
        ...
        >
          ...
          <div className="text-blue-600 font-bold text-lg mt-1 mb-2">
      ...
      <div
        className="bg-white rounded-2xl shadow-xl pt-14 pb-8 px-6 flex flex-col items-center relative -mt-8"
        style={{ overflow: "visible" }}
      >
        ...
        <div className="mb-3 text-center text-gray-700 max-w-xl">
          {user.bio}
        </div>
        <div className="flex flex-wrap gap-4 text-gray-600 text-sm mb-3 justify-center">
          {user.location && (
            <span className="flex items-center gap-1">
              <FiMapPin className="inline" /> {user.location}
            </span>
          )}
          {user.company && (
            <span className="flex items-center gap-1">
              <FiBriefcase className="inline" /> {user.company}
            </span>
          )}
        </div>
        {user.skills && user.skills.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-3 justify-center">
            {user.skills.map((skill: string) => (
              <span
                key={skill}
                className="bg-primary-50 text-primary-700 px-3 py-1 rounded-full text-xs font-semibold shadow-sm"
              >
                {skill}
              </span>
            ))}
          ...
          {user.badges && user.badges.length > 0 ? (
            <>
              {user.badges.includes("first_post") && (
                <div
                  title="First Post: Create your first post on the platform."
              ...
              {user.badges.includes("top_commenter") && (
                <div
                  title="Top Commenter: Write 10 comments on posts."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("forked_10") && (
                <div
                  title="Code Forked 10+: Have one of your code posts forked 10 or more times."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("streak_master") && (
                <div
                  title="Streak Master: Log in 7 days in a row."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("helper") && (
                <div
                  title="Helper: Answer 5+ questions/comments from others."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("popular_post") && (
                <div
                  title="Popular Post: A post received 50+ likes."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("project_creator") && (
                <div
                  title="Project Creator: Create 3+ projects."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("collaborator") && (
                <div
                  title="Collaborator: Collaborate on 2+ projects."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("first_like") && (
                <div
                  title="First Like: Receive your first like on a post."
                  className="flex flex-col items-center"
                >
              ...
              {user.badges.includes("milestone_100_followers") && (
                <div
                  title="Milestone: Reach 100 followers."
                  className="flex flex-col items-center"
                >
                  <div className="w-16 h-16 rounded-full bg-green-100 flex items-center justify-center mb-2 shadow-lg text-3xl">
          ...
          {followers.length === 0 ? (
            ...
            <ul>
              {followers.map((f) => (
                <li
                  key={f._id}
                  className="py-2 border-b last:border-b-0 flex items-center gap-2"
                >
