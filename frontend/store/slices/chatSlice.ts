...
export const sendMessage = createAsyncThunk(
  'chat/sendMessage',
  async ({ chatId, content, messageType = 'text', fileUrl = '', fileName = '' }: {
    chatId: string
    content: string
    messageType?: string
    fileUrl?: string
    ...
    const response = await chatAPI.sendMessage(chatId, { content, messageType, fileUrl, fileName })
    return response.data
  }
)
...
export const { clearError, clearCurrentChat, setSocket, addMessage, updateChat, setChats } = chatSlice.actions
